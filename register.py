...
class Register:
    def __init__(self,root):
        ...
        #=================Row1
        f_name=Label(frame1,text="Fisrt Name",font=("times new roman",15,"bold"),bg="white",fg="gray").place(x=50,y=100)
        ...
        #=================Row3
        question=Label(frame1,text="Securtiy Question",font=("times new roman",15,"bold"),bg="white",fg="gray").place(x=50,y=240)
